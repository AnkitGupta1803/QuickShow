...
const NavBar = () => {
    ...
    return (
        <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
            ...
            <Link to='/' className='max-md:flex-1' >
                ...
                <img src={assets.logo} alt='logo' className='w-32 md:w-40 lg:w-48' />
    ...
    md:px-8 py-3 max-md:h-screen backdrop-blur
    bg-black/70 md:bg-white/10 md:border md:rounded-full border-gray-300/20
